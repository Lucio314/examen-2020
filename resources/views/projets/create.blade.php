    ...
    <div class="container">
        ...
        <form action="{{route('projets.store')}}" method="POST">
            ...
            <div class=" form-group mb-3">
                ...
                <input type="text" class="form-control" id="codeProjet" name="codeProjet" required>
            </div>
            <div class=" form-group mb-3">
            ...
            <div class=" form-group mb-3">
                ...
                <input type="date" class="form-control" id="dateLancement" name="dateLancement" required>
            </div>
            <div class=" form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <select id="codLocalite" class="form-control" name="codLocalite">
                    ...
                    <option value={{$l->codLocalite}}>{{$l->nomLocalite}}</option>
                    @endforeach
                </select>
            </div>
